...
const StoryForm: React.FC<StoryProps> = ({
  ...
  const [priority, setPriority] = useState(String(priorityInit)); // 3 => must have, 0 => won't have this time
  const [businessValue, setBusinessValue] = useState(String(businessValueInit));
