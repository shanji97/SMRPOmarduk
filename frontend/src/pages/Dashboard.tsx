        ...
        {Object.entries(columns).map(([columnId, column], index) => {
          return (
            ...
            <Card className="bg-light border-0 " key={columnId}>
              ...
              <p className="fs-6 text-muted m-1">TSK-39</p>
              <p className="fs-6 text-muted m-1  text-truncate">sivar.lapajne@gmail.com</p>
              <Dropdown className="">
                <Dropdown.Toggle variant="link" id="dropdown-custom-components" bsPrefix="p-0">
                  <ThreeDots />
                </Dropdown.Toggle>
                <Dropdown.Menu>
                  <Dropdown.Item><Pencil /> Edit</Dropdown.Item>
            ...
            <Card.Body>
              ...
              <ProgressBar style={{ height: "3px" }} now={60} />
              <div className='pt-3 hstack gap-2 '>
              
                <Clock className="text-muted" />
                <p className="fs-6 text-muted my-0"> 2h</p>
                ...
                <p className="fs-6 text-muted my-0">6</p>
